package com.artemissoftware.afroditedating.util;
...
public class Users {
    ...
    public static final User Poseidon = new User(Uri.parse("android.resource://com.artemissoftware.afroditedating/" + R.drawable.poseidon).toString(),
